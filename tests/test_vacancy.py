...
def test_filter_vacancies_positive(vacancies_for_the_filter: list) -> None:
    ...
    custom_vacancies = vacancies.custom(vacancies_for_the_filter)
    result = vacancies.filter_vacancies()
    assert result == [
        {'id': 1, 'name': 'Junior', 'area':
            {'name': 'Москва'}, 'salary':
             {'from': 100000, 'to': 120000}, 'experience':
             {'name': 'От 3 до 6'}, 'snippet':
             {'requirement': 'sql', 'responsibility': 'Помощь'}},
        {'id': 3, 'name': 'Junior', 'area':
            {'name': 'Москва'}, 'salary':
             {'from': 100000, 'to': 120000}, 'experience':
             {'name': 'От 1 до 3'}, 'snippet':
             {'requirement': 'sql', 'responsibility': 'Помощь'}},
        {'id': 7, 'name': 'Junior', 'area':
            {'name': 'Москва'}, 'salary':
             {'from': 100000, 'to': 120000}, 'experience':
             {'name': 'От 3 до 6'}, 'snippet':
             {'requirement': 'Помощь', 'responsibility': 'sql'}}
    ]
    Vacancy.custom_vacancies = []