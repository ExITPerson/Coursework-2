...
from src.file_saver import JsonSaver, TXTSaver, ExcelSaver, CSVSaver
...
def test_save_json_new_file_txt(tmp_path):
    data = [{"id": 1, "name": "Test"}]
    test1 = TXTSaver
    test1.path = str(tmp_path)
    test1.save_data(data, "test")
...
def test_update_save_data_txt(tmp_path):
    test2 = TXTSaver
    test2.path = str(tmp_path)
    initial_data = [{'id': 1, 'name': 'Test'}]
    test2.save_data(initial_data, 'test')
...
def test_del_data_txt(tmp_path):
    test3 = TXTSaver
    test3.path = tmp_path
    data = [{'id': 1, 'name': 'Test'}, {'id': 2, 'name': 'Another'}]
    test3.save_data(data, "test")
...
def test_del_data_non_file_txt(capsys):
    data = [{'id': 2, 'name': 'Another'}]
...
def test_update_save_data_xlsx(tmp_path):
    test2 = ExcelSaver
    test2.path = str(tmp_path)
    initial_data = [{'id': 1, 'name': 'Test'}]
    test2.save_data(initial_data, 'test')
...
def test_del_data_xlsx(tmp_path):
    test3 = ExcelSaver
    test3.path = tmp_path
    data = [{'id': 1, 'name': 'Test'}, {'id': 2, 'name': 'Another'}]
    test3.save_data(data, "test")
...
def test_del_data_non_file_xlsx(capsys):
    data = [{'id': 2, 'name': 'Another'}]
...
def test_save_json_new_file_xlsx(tmp_path):
    data = [{"id": 1, "name": "Test"}]
    test1 = ExcelSaver
    test1.path = str(tmp_path)
    test1.save_data(data, "test")
...
def test_update_save_data_csv(tmp_path):
    test2 = CSVSaver
    test2.path = str(tmp_path)
    initial_data = [{'id': 1, 'name': 'Test'}]
    test2.save_data(initial_data, 'test')
...
def test_del_data_csv(tmp_path):
    test3 = CSVSaver
    test3.path = tmp_path
    data = [{'id': 1, 'name': 'Test'}, {'id': 2, 'name': 'Another'}]
    test3.save_data(data, "test")
...
def test_del_data_non_file_csv(capsys):
    data = [{'id': 2, 'name': 'Another'}]
...
def test_save_json_new_file_csv(tmp_path):
    data = [{"id": 1, "name": "Test"}]
    test1 = CSVSaver
    test1.path = str(tmp_path)
    test1.save_data(data, "test")
